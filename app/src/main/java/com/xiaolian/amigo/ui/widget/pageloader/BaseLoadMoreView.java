...
/**
 * BaseLoadMoreView 上拉加载View
 * @author zcd
 */
public abstract class BaseLoadMoreView extends FrameLayout {
    private static final String TAG = BaseLoadMoreView.class.getName();
    ...
    public BaseLoadMoreView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
