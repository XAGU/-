...
public class ZoomRecyclerView2 extends RecyclerView {
  ...
  public ZoomRecyclerView2(Context context) {
    super(context);
    init(null);
  }

  public ZoomRecyclerView2(Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
    init(attrs);
  }

  public ZoomRecyclerView2(Context context, @Nullable AttributeSet attrs, int defStyle) {
  ...
  private void init(AttributeSet attr) {
    ...
    if (attr != null) {
      ...
      mMinScaleFactor =
          a.getFloat(R.styleable.ZoomRecyclerView_minScaleFactor, DEFAULT_MIN_SCALE_FACTOR);
      mMaxScaleFactor =
          a.getFloat(R.styleable.ZoomRecyclerView_maxScaleFactor, DEFAULT_MAX_SCALE_FACTOR);
      mDefaultScaleFactor = DEFAULT_SCALE_FACTOR;
      mScaleFactor = mDefaultScaleFactor;
      mScaleDuration = a.getInteger(R.styleable.ZoomRecyclerView_autoScaleTime,
