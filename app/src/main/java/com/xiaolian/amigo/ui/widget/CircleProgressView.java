...
public class CircleProgressView extends ProgressBar {
     ...
     * 已完成进度条大小
     */
    private int mReachBarSize = ScreenUtils.dpToPxInt(getContext(), 2);
    /**
     * 未完成进度条大小
     */
    private int mNormalBarSize = ScreenUtils.dpToPxInt(getContext(), 2);
    /**
     * 已完成进度颜色
     */
     ...
     * 进度值字体大小
     */
    private int mTextSize = ScreenUtils.sp2px(getContext(), 14);
    /**
     * 进度的值字体颜色
     */
     ...
     * 半径
     */
    private int mRadius = ScreenUtils.dpToPxInt(getContext(), 20);
    /**
     * 起始角度
     */
     ...
     * 内部圆与外部圆间距
     */
    private int mInnerPadding = ScreenUtils.dpToPxInt(getContext(), 1);
    /**
     * 外部圆环颜色
     */
     ...
     * 外层圆环宽度
     */
    private int mOuterSize = ScreenUtils.dpToPxInt(getContext(), 1);
    ...
    public void setReachBarSize(int reachBarSize) {
        mReachBarSize = ScreenUtils.dpToPxInt(getContext(), reachBarSize);
        invalidate();
    }
    ...
    public void setNormalBarSize(int normalBarSize) {
        mNormalBarSize = ScreenUtils.dpToPxInt(getContext(), normalBarSize);
        invalidate();
    }
    ...
    public void setRadius(int radius) {
        mRadius = ScreenUtils.dpToPxInt(getContext(), radius);
        invalidate();
    }
    ...
    public void setInnerPadding(int innerPadding) {
        mInnerPadding = ScreenUtils.dpToPxInt(getContext(), innerPadding);
        int mInnerRadius = mRadius - mOuterSize / 2 - mInnerPadding;
        rectInner = new RectF(-mInnerRadius, -mInnerRadius, mInnerRadius, mInnerRadius);
        invalidate();
    }
    ...
    public void setOuterSize(int outerSize) {
        mOuterSize = ScreenUtils.dpToPxInt(getContext(), outerSize);
        invalidate();
    }
