...
import com.xiaolian.amigo.ui.device.washer.WasherBaseActivity;
...
public class BathroomScanActivity extends BathroomBaseActivity
        implements DecoratedBarcodeView.TorchListener, IBathroomScanView {
    private static final String TAG = BathroomScanActivity.class.getSimpleName();
    private static final int FRAMING_SIZE_DIVISOR = 4;

    @Inject
    IBathroomScanPresenter<IBathroomScanView> presenter;
...
//        if (bonus == null) {
//            startActivity(new Intent(BathroomScanActivity.this, ChooseWashModeActivity.class)
