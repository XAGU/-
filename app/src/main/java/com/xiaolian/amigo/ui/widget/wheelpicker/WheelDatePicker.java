...
public class WheelDatePicker extends LinearLayout implements WheelPicker.OnItemSelectedListener,
        IWheelPicker, IWheelYearPicker, IWheelMonthPicker, IWheelDatePicker {

    private static final SimpleDateFormat SDF =
            new SimpleDateFormat("yyyy-M", Locale.getDefault());

    private WheelYearPicker mPickerYear;
    private CustomWheelMonthPicker mPickerMonth;
...
//    }
    ...
    @Override
    public CustomWheelMonthPicker getWheelMonthPicker() {
        return mPickerMonth;
    }
