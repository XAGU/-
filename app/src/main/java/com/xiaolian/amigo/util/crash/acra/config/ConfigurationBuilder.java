 ...
 */
package com.xiaolian.amigo.util.crash.acra.config;
...
import com.xiaolian.amigo.util.crash.acra.builder.NoOpReportPrimer;
import com.xiaolian.amigo.util.crash.acra.builder.ReportPrimer;
...
import com.xiaolian.amigo.util.crash.acra.file.Directory;
import com.xiaolian.amigo.util.crash.acra.security.KeyStoreFactory;
...
import static com.xiaolian.amigo.util.crash.acra.ACRAConstants.DEFAULT_APPLICATION_LOGFILE;
import static com.xiaolian.amigo.util.crash.acra.ACRAConstants.DEFAULT_APPLICATION_LOGFILE_LINES;
