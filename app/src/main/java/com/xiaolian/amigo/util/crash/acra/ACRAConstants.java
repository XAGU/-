...
import com.xiaolian.amigo.util.crash.acra.annotation.ReportsCrashes;
import com.xiaolian.amigo.util.crash.acra.model.Element;
import com.xiaolian.amigo.util.crash.acra.model.StringElement;

import static  com.xiaolian.amigo.util.crash.acra.ReportField.ANDROID_VERSION;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.APP_VERSION_CODE;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.APP_VERSION_NAME;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.AVAILABLE_MEM_SIZE;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.BRAND;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.BUILD;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.BUILD_CONFIG;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.CRASH_CONFIGURATION;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.CUSTOM_DATA;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.DEVICE_FEATURES;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.DISPLAY;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.DUMPSYS_MEMINFO;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.ENVIRONMENT;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.FILE_PATH;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.INITIAL_CONFIGURATION;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.INSTALLATION_ID;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.IS_SILENT;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.LOGCAT;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.PACKAGE_NAME;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.PHONE_MODEL;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.PRODUCT;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.REPORT_ID;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.SHARED_PREFERENCES;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.STACK_TRACE;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.TOTAL_MEM_SIZE;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.USER_APP_START_DATE;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.USER_COMMENT;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.USER_CRASH_DATE;
import static  com.xiaolian.amigo.util.crash.acra.ReportField.USER_EMAIL;
...
public final class ACRAConstants {
    ...
    /**
     * Set this extra to true to force the deletion of reports by the {@link com.xiaolian.amigo.util.crash.acra.dialog.CrashReportDialog} activity.
     */
