...
import com.xiaolian.amigo.util.crash.acra.security.KeyStoreHelper;
...
public final class HttpRequest {
    ...
    public void send(@NonNull Context context, @NonNull URL url, @NonNull Method method, @NonNull String content, @NonNull Type type) throws IOException {
        ...
        // Set Headers
        urlConnection.setRequestProperty("User-Agent", String.format("Android ACRA %1$s", "4.9.2")); //sent ACRA version to server
