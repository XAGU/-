...
import com.xiaolian.amigo.util.crash.acra.collector.CrashReportDataFactory;
import com.xiaolian.amigo.util.crash.acra.config.ACRAConfiguration;
import com.xiaolian.amigo.util.crash.acra.dialog.CrashReportDialog;
import com.xiaolian.amigo.util.crash.acra.file.CrashReportPersister;
import com.xiaolian.amigo.util.crash.acra.file.ReportLocator;
import com.xiaolian.amigo.util.crash.acra.prefs.SharedPreferencesFactory;
import com.xiaolian.amigo.util.crash.acra.sender.SenderServiceStarter;
import com.xiaolian.amigo.util.crash.acra.util.ProcessFinisher;
import com.xiaolian.amigo.util.crash.acra.util.ToastSender;
