package com.xiaolian.amigo.util.scale;

import android.view.View;
import static com.xiaolian.amigo.util.scale.AnimatorProxy.NEEDS_PROXY;
import static com.xiaolian.amigo.util.scale.AnimatorProxy.wrap;
