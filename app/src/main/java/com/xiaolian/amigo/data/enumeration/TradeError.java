...
public enum TradeError {
    ...
    DEVICE_BROKEN_1(false, R.string.device_broken_title, R.string.device_broken_tip_1, R.string.connect_error_btn, ErrorTag.CONNECT_ERROR.getCode()),
    ...
    DEVICE_BROKEN_3(false, R.string.device_broken_title, R.string.device_broken_tip_3, R.string.device_broken_btn_3, ErrorTag.CHANGE_DORMITORY.getCode()),
    SYSTEM_ERROR(false, R.string.system_error_title, R.string.system_error_tip, R.string.device_broken_btn_2, ErrorTag.REPAIR.getCode());
