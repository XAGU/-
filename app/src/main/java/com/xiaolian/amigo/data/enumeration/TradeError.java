...
public enum TradeError {
    ...
    CONNECT_ERROR_2(false, R.string.connect_error_title_2, R.string.connect_error_tip_2, R.string.i_know, ErrorTag.DEVICE_BUSY.getCode()),
    ...
    CONNECT_ERROR_5(true, R.string.connect_error_title_1, R.string.connect_error_tip_6, R.string.connect_error_btn, ErrorTag.CONNECT_ERROR.getCode()),
    DEVICE_BUSY(false, R.string.device_busy__title, R.string.device_busy_tip, R.string.i_know, ErrorTag.DEVICE_BUSY.getCode()),
    ...
    DEVICE_BROKEN_3(false, R.string.device_broken_title, R.string.device_broken_tip_3, R.string.i_know, ErrorTag.DEVICE_BUSY.getCode()),
    SYSTEM_ERROR(false, R.string.system_error_title, R.string.device_broken_tip_2, R.string.device_broken_btn_2, ErrorTag.REPAIR.getCode());
