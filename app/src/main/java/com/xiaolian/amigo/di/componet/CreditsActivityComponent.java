...
@Component(dependencies = ApplicationComponent.class, modules = CreditsActivityModule.class)
public interface CreditsActivityComponent {
    void inject(CreditsActivity activity);
}
